...
func Run() error {
	...
	steps := []step.Interface{
		...
		st016.Step{Index: 90 /****/, Value: 1e06 /*********/, Comment: "ensure 1M volume inflow in treasury"},

		st012.Step{Index: 91 /****/, Value: 6000 /*********/, Comment: "buy RSX for 4k DAI from pool"},
		st013.Step{Index: 92 /****/, Value: 2.00 /*********/, Comment: "ensure RSX price of 2.00 DAI"},

		st017.Step{Index: 93 /*****/, Value: 2e06 /********/, Comment: "ensure 2M DAI in treasury"},
		st019.Step{Index: 94 /*****/, Value: 3e06 /********/, Comment: "ensure 3M protocol debt in RSX"},
